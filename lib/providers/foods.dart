...
class Foods with ChangeNotifier {
  ...
  Food selectByName(String name) {
    return _foods.firstWhere((element) => element.title == name);
  }

  Future<void> addFood(String foodId, String title, String description,
      String category, String feedHist, String image) {
    DateTime datetimeNow = DateTime.now();

    Uri url = Uri.parse(
        "https://bambinut-df6a3-default-rtdb.firebaseio.com/Foods.json?auth=$token");
    return http
        .post(
      url,
      body: json.encode(
  ...
  Future<void> editFood(String id, String title, String description,
    ...
    Uri url = Uri.parse(
        "https://bambinut-df6a3-default-rtdb.firebaseio.com/Foods/$id.json?auth=$token");
  ...
  Future<void> initialData() async {
    ...
    Uri url = Uri.parse(
        'https://bambinut-df6a3-default-rtdb.firebaseio.com/Foods.json?auth=$token&orderBy="userId"&equalTo="$userId"');
